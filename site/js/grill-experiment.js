/* Runs in <head>, before analytics or paint. Four fixed, equal allocations.
 * Preview any design with ?preview=1. Local/non-production hosts are previews.
 * Deploy the CRM endpoint before publishing these pages. See docs/grill-box-test.md.
 */
(function () {
  "use strict";
  var experiment = "grill-box-v1";
  var variants = ["original", "minimal", "butcher", "table"];
  var paths = {
    original: "/shop/grill-box",
    minimal: "/shop/grill-box-minimal",
    butcher: "/shop/grill-box-butcher",
    table: "/shop/grill-box-table"
  };
  ...
  window.RicciGrillExperiment = context;
  if (preview || bot || variants.indexOf(current) === -1) return;

  var key = "ricci_grill_v1";
  var saved;
  try {
